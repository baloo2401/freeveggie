...
public interface IGardenBean {
    ...
    /**
     * Update all the information of the garden. Only the owner of the garden or
     * a super administrator can update a garden. An update is possible only on
     * garden that have status to created.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
    ...
    /**
     * Blacklist a {@link GardenBO}. Only a super administrator or a system user
     * can blacklist a garden. The blacklist will make this {@link GardenBO} not
     * visible to any other user because of trust issues or because to many user
     * complain about the {@link GardenBO}. An update is possible only on garden
     * that have status to created.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
    ...
    /**
     * Unblacklist a {@link GardenBO}. Only a super administrator or a system
     * user can unblacklist a garden. It put the garden back to created.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
     * @param pGardenId - The garden to blacklist
     * @return <codeTrue</code> if the update run successfully,
    ...
    /**
     * Delete a {@link GardenBO}. Only the owner of a garden or a super
     * administrator can delete a garden. Delete is not physical, it's just a
     * status. An update is possible only on garden that have status to created.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
     * @param pGardenId - The garden to blacklist
     * @return <codeTrue</code> if the update run successfully,
    ...
    /**
     * Undelete a {@link GardenBO}. Only the owner of a garden or a super
     * administrator can uddelete a garden. Undelete a garden is possible only
     * if the garden is deleted and it's set back to create status.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
     * @param pGardenId - The garden to blacklist
     * @return <codeTrue</code> if the update run successfully,
    ...
    /**
     * Archive a {@link GardenBO}. Only a system user can archive a garden. This
     * operation can be made only on a garden that has is status to Created.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
    ...
    /**
     * Unarchive a {@link GardenBO}. Only a owner of the garden can make this
     * update.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
     * @param pGardenId - The id of the garden to update
    ...
    /**
     * Get all {@link GardenBO} of a {@link UserBO}. If the technical
     * information doesn't ask for the opposite the service return only garden
    ...
    /**
     * Get all {@link GardenBO} of a {@link RefCityBO} having a given
     * {@link RefProductBO}.If the technical information doesn't ask for the
     * opposite the service return only garden that have their status to
     * CREATED.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
    ...
    /**
     * Get all {@link GardenBO} of a region having a given product. If the
     * technical information doesn't ask for the opposite the service return
     * only garden that have their status to CREATED.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
    ...
    /**
     * Delete a {@link GardenCommentBO}. Only the writer of the comment or a
     * super administrator can delete a garden. Delete is not physical, it's
     * just a status. An update is possible only on garden that have status to
     * created.
     *
     * @param pContextMsg
    ...
    /**
     * Undelete a {@link GardenCommentBO}. Only the writer of the comment or a
    ...
    /**
     * Archive a {@link GardenCommentBO}. Only a system user can archive a
     * garden. This operation can be made only on a garden that has is status to
     * Created.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
    ...
    /**
     * Unarchive a {@link GardenCommentBO}. Only a owner of the garden can make
     * this update.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
    ...
    /**
     * Get all {@link GardenCommentBO} of a write by a given {@link UserBO}. If
    ...
    /**
     * Create a like tag on a garden. If the like already exist the request will
     * be either ignore or will but the like back to setted.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
    ...
    /**
     * Unlike tag on a garden. This will just change the status of the like to
    ...
    /**
     * Get all {@link GardenLikeBO} of a given {@link GardenBO}.If the technical
     * information doesn't ask for the opposite the service return only like
     * that have their status to SETTED.
     *
     * @param pContextMsg - The {@link ContextMsg} of the service call
    ...
    /**
     * Get all {@link GardenLikeBO} write by a given {@link UserBO}.If the
     * technical information doesn't ask for the opposite the service return
