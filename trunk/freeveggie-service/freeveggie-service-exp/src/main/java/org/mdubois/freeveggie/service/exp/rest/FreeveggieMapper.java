...
public class FreeveggieMapper extends ObjectMapper {
	 ...
	 * 
	 * If used to serialize {@link MessageEnum} it will write only the int value.
	 */
	protected static final ObjectMapper MAPPER = new ObjectMapper().setVisibility(JsonMethod.FIELD, JsonAutoDetect.Visibility.ANY).setVisibility(JsonMethod.GETTER, JsonAutoDetect.Visibility.NONE);
