 ...
 */
public abstract class StatDaoUnitTest {
    ...
    public static void setUpClass() throws Exception {
        if (_databaseInit == false) {
            try {
                ...
                connection = DriverManager.getConnection("jdbc:hsqldb:mem:unit-testing-jpa-stat", "sa", "");
            ...
            try {
                emFactory = Persistence.createEntityManagerFactory("FREEVEGGIE_PU_TEST_STAT");
    ...
    protected static File getDatasetFile() {
        return new File("./src/test/resources/stat-dataset.xml");
    }
}