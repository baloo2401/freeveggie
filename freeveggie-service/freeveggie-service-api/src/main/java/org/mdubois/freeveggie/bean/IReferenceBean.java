 ...
 */
public interface IReferenceBean {

    /**
     * Get all {@link RefCityMsg} in a given {@link RefCountryMsg}. The result
     * is ordered by name.
     *
     * @param pRefCountryId - The given {@link RefCountryMsg}
     * @param pPagination - The {@link Pagination} in wish the result should be
     * return
     * @return A {@link List} of {@link {@link RefCityMsg}
    ...
    /**
     * Get all {@link RefCityMsg} by the beginning name. The result is ordered
     * by name.
     *
    ...
    /**
     * Get all {@link RefCityMsg} by the beginning zip code. The result is ordered
     * by name.
     *
     ...
     * @throws BusinessException In case of any business issue
     */
    List<RefCityMsg> getRefCitiesByZipCode(Integer pZipCode, Pagination pPagination) throws BusinessException;

    /**
     * Get all {@link RefCityMsg} in a given {@link RefRegionMsg}. The result is
     * ordered by name.
     *
    ...
    /**
     * Get all {@link RefCityMsg} in a given {@link RefStateMsg}. The result is
     * ordered by name.
     *
    ...
    /**
     **** Get all {@link RefCountryMsg} starting with a given name. The result
     * is ordered by name.
     *
     * @param pName - The country name to look for
     * @param pPagination - The {@link Pagination} in wish the result should be
     * return
     * @return A {@link List} of {@link {@link RefCountryMsg}
     * @throws BusinessException In case of any business issue
     */
     ...
     *
     * @param pName - The beggining of the product name we are looking for.
     * @param pTechnicalInformation - The {@link TechnicalInformation} to
     * respect
     * @return A {@link List} of {@link {@link RefProductMsg}
     * @throws BusinessException In case of any business issue
    ...
    /**
     * Get all {@link RefProductMsg} that can be reap during a given
     * {@link List} of {@link RefMonthMsg}.
     *
     * @param pRefMonthIds - The {@link List} of {@link RefMonthMsg} that the
    ...
    /**
     * Get all {@link RefProductMsg} that can be seed during a given
     * {@link List} of {@link RefMonthMsg}.
     *
     * @param pRefMonthIds - The {@link List} of {@link RefMonthMsg} that the
    ...
    /**
     * Get all {@link RefRegionMsg} for a given {@link RefCountryMsg}. The
     * result is ordered by name.
     *
     * @param pRefCountryMsg - The given {@link RefCountryMsg}
     * @param pPagination - The {@link Pagination} in wish the result should be
     * return
     * @return A {@link List} of {@link {@link RefRegionMsg}
     * @throws BusinessException In case of any business issue
     */
    ...
    /**
     * Get all {@link RefRegionMsg} starting by the given name. The result is
     * ordered by name.
     *
    ...
    /**
     * Get all {@link RefRegionMsg} for a given {@link RefStateMsg}. The result
     * is ordered by name.
     *
     * @param pRefStateId - The given {@link RefStateMsg}
     * @param pPagination - The {@link Pagination} in wish the result should be
    ...
    /**
     * Get all {@link RefStateMsg} in a given {@link RefCountryMsg}. The result
     * is ordered by name.
     *
     * @param pRefCountryId - The give {@link RefCountryMsg}
     * @param pPagination - The {@link Pagination} in wish the result should be
     * return
     * @return A {@link List} of {@link {@link RefStateMsg}
     * @throws BusinessException In case of any business issue
     */
    List<RefStateMsg> getRefStatesByCountry(final Integer pRefCountryId, final Pagination pPagination) throws BusinessException;

    /**
     * Get all {@link RefStateMsg} starting by a given name. The result is
     * ordered by name.
     *
     * @param pName - The region name to look for
     * @param pPagination - The {@link Pagination} in wish the result should be
