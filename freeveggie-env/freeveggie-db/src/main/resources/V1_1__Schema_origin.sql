...
CREATE TABLE t_address (
    ...
    adr_line_1 character varying(128),
    adr_line_2 character varying(128),
    adr_rci_id integer,
    adr_latitude double precision,
    adr_longitude double precision,
    adr_locality character(128),
    adr_adm_area_l2 character(128),
    adr_adm_area_l1 character(128),
    adr_country character(128),
    adr_postal_code character(128),
    adr_street_name character varying(1024)
);
...
--
-- Name: COLUMN t_address.adr_line_1; Type: COMMENT; Schema: public; Owner: freeveggieprod
--
...
--
-- Name: COLUMN t_address.adr_line_2; Type: COMMENT; Schema: public; Owner: freeveggieprod
--
...
CREATE TABLE t_user (
    ...
    usr_uuid character varying(64) NOT NULL
);
...
--
-- Name: public; Type: ACL; Schema: -; Owner: freeveggieprod
--

REVOKE ALL ON SCHEMA public FROM PUBLIC;
REVOKE ALL ON SCHEMA public FROM freeveggieprod;
GRANT ALL ON SCHEMA public TO freeveggieprod;
