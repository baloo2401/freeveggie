...
@Authenticated
public class GardenLikeController extends FreeveggieController {

	/**
	 * Name resource service.
	 */
	private static final String WEB_SERVICE_PATH = "/gardenlike";
	...
	public static Result getGardenLikeById(final Long id) throws JsonGenerationException, JsonMappingException,
			IOException {
	...
	public static Result getGardenLikeByUser(final Long id) throws JsonGenerationException, JsonMappingException,
			IOException {
	...
	public static Result getGardenLikeByGarden(final Long id) throws JsonGenerationException, JsonMappingException,
			IOException {
